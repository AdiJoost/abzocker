...
modelName = "MoE_LSTM_ALT_LOSS.keras"
...
def main():
    ...
    model = MixtureOfExpertsLSTM(numberOfExperts, inputLength, numberOfFeatures, name="mixture_of_experts_LSTM_ALT_LOSS", input_shape=input_shape)
